    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={stat.label} className="bg-white rounded-xl p-6 border border-[hsl(220,20%,90%)]">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-3" style={{ backgroundColor: stat.color }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 bg-white rounded-xl border border-[hsl(220,20%,90%)] p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => onNavigate("cultos")} className="text-sm text-[hsl(var(--primary))] hover:underline">
              Ver todos →
            </button>
          </div>
