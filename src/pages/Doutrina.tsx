...
import { User, Calendar, BookOpen, ArrowRight, Search } from "lucide-react";
...
const Doutrina = () => {
  ...
  const filtered = doutrinas.filter((e) => {
        ...
        <section className="relative pt-24 pb-16 overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl px-4 relative z-10 text-center">
            ...
            <p className="text-[hsl(215,20%,75%)] text-lg max-w-2xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
              Estudos doutrinários para edificação e crescimento espiritual
            </p>
            ...
            <div className="flex items-center justify-center gap-8 mt-8 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              <div className="text-center">
                <p className="text-2xl font-bold text-[hsl(var(--primary))]">{doutrinas.length}</p>
                <p className="text-xs text-[hsl(215,20%,65%)]">Estudos</p>
              </div>
              <div className="w-px h-8 bg-white/20" />
              <div className="text-center">
                <p className="text-2xl font-bold text-[hsl(var(--primary))]">
                  {new Set(doutrinas.map((e) => e.autor)).size}
                </p>
